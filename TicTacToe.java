...
public class TicTacToe {
	...
	//Shows the table with any values if necessary
	...
	//Method that takes in the row# and column# 
	//to place the player's sign
	...
	//Method that checks to see if the table is full or if it is empty
	...
	//This method checks to see if there is a player who won
	//either diagonally, across, or vertically
